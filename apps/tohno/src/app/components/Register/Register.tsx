...
export default function Register() {
  ...
  const handleRegister = () => {
    ...
    // 2. API Call to your friend's backend
  ...
  return (
    <div className="p-8 max-w-md mx-auto border rounded-xl bg-white shadow-lg mt-10">
      ...
      <p className="mt-6 text-center text-sm text-gray-500">
        Already have an account? <span className="text-blue-600 cursor-pointer font-medium hover:underline" onClick={() => window.location.href = '/login'}>Log in</span>
      </p>
    </div>
  );
}